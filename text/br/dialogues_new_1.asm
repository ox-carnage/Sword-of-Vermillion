...
text_dialogue_03:
	...
	NULL
text_dialogue_04:
	dialogue_text("Which Book of Spells do")
	dialogue_text("you want to put down?")
	end()
text_dialogue_05:
	dialogue_text("From which Book do you")
	dialogue_text("wish to cast a spell?")
	end()
	NULL
text_dialogue_06:
	dialogue_text("Which Book do you want")
	dialogue_text("to ready for combat?")
	end()
text_dialogue_07:
