...
text_dialogue_160:
	...
	dialogue_text("uma coisa importante para contar!")
	new_page()
	...
	dialogue_text("pode salvar o mundo!")
	new_page()
	dialogue_text("Os exércitos de Cartahena estão")
	dialogue_text("marchando para à conquista.")
	new_page()
	dialogue_text("Você deve salvar o mundo de Cartahena!")
	new_page()
	dialogue_text("Eu guardei dinheiro para isso! Equipe-se")
	dialogue_text("muito bem pois o caminho é perigoso!")
	new_page()
	dialogue_text("Sinto muito por ficar em silêncio")
	dialogue_text("até agora...")
	new_page()
	dialogue_text("O Rei Erik teria orgulho de você")
	dialogue_text("assim como eu tambem tenho!")
	new_page()
	dialogue_text("Agora vá e lembre de mim.")
