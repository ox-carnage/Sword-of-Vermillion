...
text_dialogue_00:
	...
	NULL
text_dialogue_01:
	dialogue_text("Qual item você quer descartar?")
	end()
	NULL
text_dialogue_02:
...
text_dialogue_03:
	...
	NULL
text_dialogue_04:
	dialogue_text("Que Livro de Feitiços você deseja colocar?")
	end()
text_dialogue_05:
	dialogue_text("Qual Livro você deseja lançar um feitiço?")
	end()
	NULL
text_dialogue_06:
...
text_dialogue_15:
	...
	NULL
text_dialogue_16:
	dialogue_text("Desculpe, mas não")
	dialogue_text("há nada aqui dentro.")
	end()
	NULL
text_dialogue_17:
...
text_dialogue_65:
    ...
    NULL
text_dialogue_66:
    dialogue_text("Você não pode deixar cair um item amaldiçoado!")
    end()
    NULL
text_dialogue_67:
    dialogue_text("Você não pode trocar um item amaldiçoado.")
    end()
    NULL
text_dialogue_68:
...
text_dialogue_142:
    ...
    NULL
text_dialogue_143:
    dialogue_text("Você não pode aceitar, é uma caixa!")
    end()
    NULL
text_dialogue_144:
...
text_dialogue_151:
    ...
    NULL
text_dialogue_152:
    dialogue_text("Você baniu o mal de nossa terra!")
    end()
    NULL
text_dialogue_153:
    dialogue_text("Seja bem-vindo, tolo!")
    dialogue_text("Tsarkon foi para o leste para a Caverna de Thule.")
    new_page()
    dialogue_text("Ele me pediu que lhe desse um presente")
    dialogue_text("esta cidade como seu túmulo! Prepare-se para morrer!ø")
    db $155
    db $F156
    db $E157
text_dialogue_154:
    dialogue_text("Você pode ter me vencido, mas nunca ")
    dialogue_text("derrotará Tsarkon!ø S")
    db $159   
    NULL
text_dialogue_155:
    dialogue_text("÷, se ao menos Erik pudesse vê-lo agora.")
    dialogue_text("Ele teria muito orgulho de você!")
    new_page()
    dialogue_text("Nunca fui mulher de Tsarkon, ele sempre")
    dialogue_text("tentou, e quando o recusei, ele me transformou em pedra.")
    new_page()
    dialogue_text("Mas a sua bravura finalmente me libertou.")
    end()
text_dialogue_156:
    dialogue_text("Por favor, fique na frente do trono e")
    dialogue_text("use os anéis. O dia que irá curar as")
    new_page()
    dialogue_text("feridas abertas por Tsarkon esta chegando.")
    end()
text_dialogue_157:
    dialogue_text("Agora você deve ficar na frente do trono")
    dialogue_text("e usar os anéis. ")
    new_page()
    dialogue_text("Somente você pode banir os demônios")
    dialogue_text("dos últimos 163 anos.")
    end()
    NULL
text_dialogue_158:
    dialogue_text("Agora que os anéis do bem e do mal estão")
	dialogue_text("unidos, o mundo pode voltar a ser como era antes")
	new_page()
	dialogue_text("Corra para o trono e use os anéis!")
    end()
    NULL
text_dialogue_159:
    dialogue_text("Só depende de você criar o mundo que")
    dialogue_text("Erik e Tsarkon tanto queriam.")
	new_page()
	dialogue_text("Fique em frente ao trono e use os anéis.")	
    end()
    NULL
text_dialogue_160:
...
text_dialogue_161:
    ...
    dialogue_text("O rei de Parma tem um igual!")
    end()
    NULL
text_dialogue_162:
...
text_dialogue_163:
    dialogue_text("Há um anel em uma caverna ao sul daqui.")
    dialogue_text("Tome, aqui está um mapa para guiá-lo.ù")
    db $170
    db $171
    db $172
    db $173
text_dialogue_164:
    dialogue_text("Eu estou surpreso por você ter retornado vivo!")
    end()
    NULL
text_dialogue_165:
    ...
    NULL
text_dialogue_166:
    dialogue_text("Agora a sua jornada começará!")
    dialogue_text("Aqui está um mapa da rota para Parma.ù")
    db $177
    db $178
    db $179
    db $180
    ...
    db $187
text_dialogue_167:
    dialogue_text("pTodos nós lamentamos muito pela")
    dialogue_text("morte de Blade.")
    end()
text_dialogue_168:
...
text_dialogue_174:
    dialogue_text("Corra, ÷, seu pai está quase morreno.")
	end()
    NULL
text_dialogue_175:
    dialogue_text("Todos nós compartilhamos da sua tristeza.")					
	end()
    NULL
text_dialogue_176:
...
text_dialogue_179:
    ...
    NULL
text_dialogue_180:
    dialogue_text("Visite igrejas com frequência! Lá você poderá")
	dialogue_text("salvar suas viagens para uso posterior.")
	end()
text_dialogue_181:
...
text_dialogue_184:
	...
	new_page()
	dialogue_text("Mesmo parecendo ser seres humanos,")
	dialogue_text("por dentro são monstros horríveis!")
	end()
text_dialogue_185:
    dialogue_text("Oh, este anel...")
	new_page()
	dialogue_text("deve ser propriedade da família real.")
	dialogue_text("Por que você está com ele?")
	end()
text_dialogue_186:
    dialogue_text("A cartomante pode ter ótimos  ")
	dialogue_text("conselhos para você.")
	end()
    NULL
text_dialogue_187:
...
text_dialogue_192:
	...
	dialogue_text("Não há mais o que fazer!")
    end()
    NULL
text_dialogue_193:
...
text_dialogue_194:
    ...
    NULL
text_dialogue_195:
    dialogue_text("÷, finalmente você chegou! Tenho uma coisa")
	dialogue_text("importante para te contar! Eu não sou o seu")
    dialogue_text("verdadeiro pai!")
    new_page()
    dialogue_text("Você é o filho de Erik de Excalabria morto")
	dialogue_text("por Tsarkon de Cartagena!")
    new_page()
    dialogue_text("Enquanto o castelo ardia em chamas, o rei Erik")
	dialogue_text("implorou para que")
    new_page()
    dialogue_text("eu o salvasse e o cria-lo como se fosse meu filho!")
	new_page()
	...
	new_page()
	dialogue_text("Agora vá e nunca se esqueça de quem você é....ù")
   db $217
    NULL
text_dialogue_196:
...
text_dialogue_197:
    ...
    NULL
text_dialogue_198:
    dialogue_text("Só você pode nos salvar de Cartagena.")
...
text_dialogue_201:
    dialogue_text("Se você entrar em uma caverna sem velas,")
	dialogue_text("sua tarefa será de fato muito difícil. ")
	end()
    NULL
text_dialogue_202:
